...
<div>
  ...
  <p style="font-size: 20px; color: #49361c;">verification link: <a style="color: rgb(88, 137, 87);" href="{{ URL::to('register/verify/' . $user['confirmation_token']) }}">{{ URL::to('register/verify/' . $user['confirmation_token']) }}</a></p>
</div>
